...
class DataPtkExport implements FromCollection, WithHeadings, ShouldAutoSize
{
    ...
    {
        return DataPTK::with(['sekolah', 'kategori', 'jabatan', 'bidang', 'pangkat_golongan'])
            ->when($this->sekolahId, function ($query) {
    ...
    {
        return ['Nama PTK', 'NPSN', 'Nama Sekolah', 'Kategori', 'Jabatan', 'Bidang Sertifikasi', 'Pangkat / Golongan', 'TMT Pengangkatan'];
    }
}
