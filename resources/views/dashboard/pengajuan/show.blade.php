            ...
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm mb-4">
                            ...
                            <div class="col-12">
                                ...
                                <div class="bg-light rounded p-3">
                                    <p class="mb-0" style="white-space: pre-line">
                                        {{ $pengajuanPtk->alasan_pengajuan }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        ...
                        <div
                            class="card-header bg-white border-bottom fw-semibold d-flex align-items-center gap-2 py-3">
                        ...
                        <div class="card-body">
                            ...
                            @if ($pengajuanPtk->lampiran->isEmpty())
                            ...
                            @else
                                <div class="list-group">
                                    ...
                                    @foreach ($pengajuanPtk->lampiran as $lampiran)
                                        <div class="list-group-item">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <a href="{{ asset('storage/' . $lampiran->path_file) }}" download
                ...
                <div class="d-flex gap-2">
                    @if (in_array($pengajuanPtk->status, ['menunggu', 'ditolak']))
                        ...
                        <form action="{{ route('pengajuan-ptk.destroy', $pengajuanPtk) }}" method="POST"
                            class="js-delete-form" data-confirm-text="Pengajuan ini akan dihapus permanen.">
                            @csrf @method('DELETE')
                    ...
                    <div class="card-body">
                        <dl class="row mb-0 small">
                            ...
                            @if ($pengajuanPtk->diproses_at && $pengajuanPtk->status !== 'menunggu')
                                ...
                                <dd class="col-7 fw-semibold mb-0">{{ $pengajuanPtk->diproses_at?->format('d M Y') }}
                                </dd>
                            @endif
                        </dl>
                    </div>
                            ...
                            <form method="POST" action="{{ route('pengajuan-ptk.update-status', $pengajuanPtk) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="status" id="statusAdmin" class="form-select">
                                        <option value="proses" {{ $pengajuanPtk->status == 'proses' ? 'selected' : '' }}>
                                            Diproses</option>
                                        <option value="disetujui"
                                            {{ $pengajuanPtk->status == 'disetujui' ? 'selected' : '' }}>Disetujui</option>
                                        <option value="ditolak"
                                            {{ $pengajuanPtk->status == 'ditolak' ? 'selected' : '' }}>Ditolak</option>
                                    </select>
                                </div>
