...
Route::prefix('dashboard')->middleware('auth')->group(function () {
    ...
    Route::middleware('role:operator_sekolah')->group(function () {
        ...
        Route::get('/sekolah/{sekolah}/data-ptk', [SekolahController::class, 'dataPtk'])->name('sekolah.data-ptk');
    });
    ...
    Route::middleware('role:admin')->group(function () {
        ...
        Route::get('/data-ptk/export', [DataPTKController::class, 'export'])->name('data-ptk.export');
